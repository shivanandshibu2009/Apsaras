...
const About = () => {
  ...
  return (
    <section id="about" className="py-24 bg-[#121010]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-[4/5] rounded-[2rem] overflow-hidden relative border border-[#c5a059]/20">
              <Image
            ...
            {/* Floating Badge */}
            <div className="absolute -bottom-10 -right-10 bg-[#c5a059] text-black p-10 rounded-full w-40 h-40 flex flex-col items-center justify-center text-center shadow-2xl border-8 border-[#121010] z-10">
              <span className="text-3xl font-serif font-bold">10+</span>
              <span className="text-[10px] uppercase font-bold tracking-widest leading-none mt-1">Years of Trust</span>
            </div>
          </motion.div>
          ...
          <div>
            ...
            >
              <h2 className="text-xs uppercase tracking-[0.3em] font-bold text-[#c5a059] mb-4">Our Story</h2>
              <h3 className="text-4xl md:text-5xl font-serif font-light text-white mb-8">
                The Path to <span className="italic text-[#c5a059]">Perfection</span>
              </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {highlights.map((item, index) => (
                ...
                >
                  <div className="bg-[#c5a059]/10 w-12 h-12 rounded-xl flex items-center justify-center border border-[#c5a059]/20 group-hover:bg-[#c5a059]/20 transition-all">
                    {item.icon}
                  </div>
