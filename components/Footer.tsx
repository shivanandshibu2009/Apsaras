        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-serif font-bold tracking-tight">APSARAS</span>
            </div>
            ...
            <div className="flex space-x-4">
              <a href="https://instagram.com/apsaras_by_reshmashibu" target="_blank" rel="noopener noreferrer" className="bg-white/5 p-3 rounded-full hover:bg-amber-600 transition-all">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm uppercase tracking-[0.2em] font-bold text-amber-400 mb-8 font-sans">Explore</h4>
            <ul className="space-y-4">
              {['Home', 'About', 'Services', 'Booking', 'Locations'].map((link) => (
                <li key={link}>
                  <a href={`#${link.toLowerCase()}`} className="text-stone-400 hover:text-white transition-colors text-sm font-light">
                    {link}
                  </a>
                </li>
              ))}
          ...
          {/* Locations */}
          <div>
            <h4 className="text-sm uppercase tracking-[0.2em] font-bold text-amber-400 mb-8 font-sans">Find Us</h4>
            <ul className="space-y-6">
              <li className="flex gap-3">
                <MapPin className="w-5 h-5 text-stone-500 shrink-0" />
                <div className="text-stone-400 text-xs font-light space-y-1">
          ...
          {/* Contact */}
          <div>
            <h4 className="text-sm uppercase tracking-[0.2em] font-bold text-amber-400 mb-8 font-sans">Contact</h4>
            <ul className="space-y-6">
              <li className="flex items-center gap-3 group">
                <div className="bg-amber-600 p-2 rounded-lg">
                  <Phone className="w-4 h-4 text-white" />
                </div>
                <a href="tel:9447531988" className="text-white font-bold hover:text-amber-400 transition-colors">
                  9447531988
                </a>
              </li>
              <li className="flex items-center gap-3">
                ...
                <p className="text-stone-400 text-sm font-light">Available on WhatsApp</p>
              </li>
              <li className="flex items-center gap-3">
                <div className="bg-stone-800 p-2 rounded-lg">
                  <Mail className="w-4 h-4 text-white" />
                </div>
                <p className="text-stone-400 text-sm font-light">apsaras@beauty.com</p>
              </li>
            </ul>
          </div>
        </div>
